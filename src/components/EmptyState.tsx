...
export default function EmptyState() {
  return (
    <div className="mt-v32 flex min-h-[280px] flex-col items-center justify-center gap-v18 rounded-[22px] border border-dashed border-line bg-surface/60 px-6 py-[var(--p-empty)] md:min-h-[var(--h-empty)]">
